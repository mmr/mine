/*
 *
 * $Id: mine.c,v 1.2 2006/01/13 00:35:56 mmr Exp $
 *
 * MMR Mine
 *
 */
...
main(int argc, char **argv) {
    ...
    while(i<mines)
    {
        ...
        minefield[row][col] = 1;
        fprintf(stderr, "minefield[%d][%d] = 1 (i = %d)\n", row, col, i);
        i++;
    }
